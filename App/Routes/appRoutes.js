module.exports = function(app) {
    ...
    app.route('/praticiens')
        .get(praticiens.nombres_pages)
        .post(praticiens.create_praticien);

    app.route('/praticiens/:numPage')
        .get(praticiens.list_all_praticiens)

    app.route('/praticiens/id/:praticienId')
    ...
    app.route('/medicaments/:numPage')
        .get(medicaments.list_all_medicaments);

    app.route('/medicaments/id/:medicamentId')
